	...
	<body>
		...
		<div id="show-person" class="content scaffold-show" role="main">
			...
			<ol class="property-list person">
				...
				<g:if test="${personInstance?.caronas}">
				<li class="fieldcontain">
					<span id="caronas-label" class="property-label"><g:message code="person.caronas.label" default="Caronas" /></span>
					
						<g:each in="${personInstance.caronas}" var="c">
						<span class="property-value" aria-labelledby="caronas-label"><g:link controller="carona" action="show" id="${c.id}">${c?.encodeAsHTML()}</g:link></span>
						</g:each>
